/*
 ...
 Source Server         : 107.173.180.186
 Source Server Type    : MySQL
 Source Server Version : 50744
 Source Host           : 107.173.180.186:3306
...
CREATE TABLE `dev_log`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '开发日志' ROW_FORMAT = DYNAMIC;
